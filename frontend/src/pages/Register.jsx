  ...
  async function handelForm(e) {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/api/regdata`,
        {
          method: "POST",
      ...
      <div className="bg-white w-full max-w-md p-6 rounded-xl shadow-lg relative mx-4">
        ...
        <form action="" onSubmit={handelForm}>
          ...
          <input
            ...
            placeholder="Name"
            id=""
            className="w-full border border-gray-300 px-4 py-2 rounded focus:outline-none focus:ring-2 focus:ring-green-500 mb-2"
          />
          ...
          <button
            type="submit"
            className="w-full bg-green-600 hover:bg-green-800 text-white rounded py-2 mt-6 font-semibold"
          >
            Register
          </button>
        </form>
