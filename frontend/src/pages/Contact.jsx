...
const Contact = () => {
  ...
  async function handleForm(e) {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/api/userquery`,
        {
          method: "POST",
  ...
  return (
    <div className="max-w-3xl mx-auto mt-24 p-6 bg-white rounded-xl shadow-xl">
      <h2 className="text-2xl font-bold text-green-500 mb-5 text-center">
        Query Form
      </h2>
      ...
      <form action="" onSubmit={handleForm}>
        ...
        <button
          type="submit"
          className="bg-green-500 w-full text-white px-6 py-2 mt-3 rounded hover:bg-green-700 transition"
        >
          Submit Query
        </button>
      </form>
